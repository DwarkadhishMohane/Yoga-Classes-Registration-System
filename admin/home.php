...
<div class="row">
    ...
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number text-right h5">
          <?php 
            $categories = $conn->query("SELECT * FROM category_list where `status` = 1 and delete_flag = 0")->num_rows;
  ...
  <div class="col-12 col-sm-6 col-md-6">
    <div class="info-box">
      <span class="info-box-icon bg-gradient-dark elevation-1"><i class="fas fa-praying-hands"></i></span>
      <div class="info-box-content">
  ...
  <div class="col-12 col-sm-6 col-md-6">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number text-right h5">
          <?php 
            $registrations = $conn->query("SELECT id FROM registration_list where `status` = 1 and `delete_flag` =0")->num_rows;
