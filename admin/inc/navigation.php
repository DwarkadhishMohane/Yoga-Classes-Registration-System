              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="./?page=classes" class="nav-link nav-classes">
                    ...
                    <li class="nav-item dropdown">
                      <a href="./?page=registrations" class="nav-link nav-registrations">
                        <i class="nav-icon fas fa-file-alt"></i>
                        <?php 
                        $registrations = $conn->query("SELECT id FROM registration_list where `status` = 0 and `delete_flag` =0")->num_rows;
                        $registrations = $registrations > 0 ? format_num($registrations) : ''; 
                        ?>
                        <p>
                          Registration Requests <span class="ml-2 badge badge-danger bg-gradient-danger"><?= $registrations ?></span>
                        </p>
                      </a>
                    </li> 
                    <li class="nav-item dropdown">
                      <a href="./?page=inquiries" class="nav-link nav-inquiries">
                        ...
                        ?>
                        <p>
                          Inquiries <span class="ml-2 badge badge-danger bg-gradient-danger"><?= $inquiries ?></span>
                        </p>
                      </a>
                    </li> 
