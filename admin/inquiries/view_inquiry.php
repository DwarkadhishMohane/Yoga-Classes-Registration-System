    ...
    <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
        <div class="card card-outline card-dark rounded-0 shadow">
                ...
                <div class="container-fluid">
                    <fieldset>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <label for="" class="control-label text-muted">Subject</label>
                                <div class="pl-4 font-weight-bolder"><?= isset($subject) ? $subject : '' ?></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <label for="" class="control-label text-muted">Message</label>
                                <div class="pl-4"><?= isset($message) ? (str_replace(["\n\r", "\n", "\r"], '<br>', htmlspecialchars_decode($message))) : '' ?></div>
                            </div>
                        </div>
                    </fieldset>
                </div>
            ...
            <div class="card-footer py-1 text-center">
                <button id="delete_inquiry" class="btn btn-danger btn-flat bg-gradient-danger btn-sm" type="button"><i class="fa fa-trash"></i> Delete</button>
